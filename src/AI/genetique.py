from operator import (
    itemgetter,
)  # Indiquer ici à quoi cet import sert dans le code (en quelques mots)
import random  # idem
...
class Genetique(object):
    ...
    def __init__(self, cint, T, Text, Tint, Pint, numeroGeneration):
        ...
        self.POURCENTAGE_CONSERVATION_FORT = (
            0.2  # Détailler à quoi cette variable sert ici
        )
        self.CHANCE_SURVIE_FAIBLE = (
            0.05  # Détailler ici à quoi sert cette variable
        )
