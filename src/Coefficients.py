...
from random import gauss    # Loi gaussienne utilisée pour générer des coefficients aléatoires
...
muC = 5E+1  # Valeur moyenne
sigC = 10E+1    # Ecart type
minC = 1E+1    # Valeur minimale (> 0)
