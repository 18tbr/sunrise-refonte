...
class PageLectureConfiguration(tk.Frame):
    ...
    def __init__(self, interfaceParente):
        ...
        # Un champs dans lequel on stockera les valeurs pour le constructeurs lorsque l'utilisateur les aura confirmées
    ...
    def confirmerValeurs(self):
        # On récupère les valeurs dans tous les champs et on essaie de les utiliser pour la simulation. Si on problème de conversion apparait, la valeur par défaut sera gardée.

        # A la fin de la méthode, on renvoie la liste des valeurs pour le constructeur de Genetique.
